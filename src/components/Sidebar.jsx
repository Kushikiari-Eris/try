...
const Sidebar = ({isSidebarOpen}) =>{
    ...
    return(
        <>
        <aside  className={`fixed top-0 left-0 z-40 w-64 h-full pt-20 transition-transform transform sm:translate-x-0 dark:border-gray-700 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} bg-white border-r border-gray-200`}   >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium">   
                ...
                <li>
                <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" onClick={toggleDropdown}>
                ...
                <ul className={`${isDropdownOpen ? 'block' : 'hidden'} py-2 space-y-2`}>
                    <li>
                        <a href="/product" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</a>
                    </li>
                    <li>
